...
SOURCES = src/main.cpp src/math/vector.cpp src/math/matrix.cpp src/mz_apo/mzapo_phys.c src/mz_apo/mzapo_parlcd.c src/mz_apo/serialize_lock.c src/peripherals/input.cpp src/geometry/cube.cpp src/geometry/camera.cpp src/peripherals/mapping.cpp
...
# ===================== Virtual Build (runv) =====================
runv_SRC = src/render/test_render.cpp src/periphs_virtual/input.cpp src/periphs_virtual/output.cpp src/geometry/cube.cpp src/geometry/side.cpp src/geometry/camera.cpp src/math/vector.cpp src/math/matrix.cpp src/math/utils.cpp src/render/color.cpp src/render/render.cpp
